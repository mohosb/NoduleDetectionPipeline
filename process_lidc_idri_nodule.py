from ct_data_management.acquisition import IDCFileSystemDataManager, LIDC_IDRI_INFO
...
if __name__ == '__main__':
    DATA_PATH = '/mnt/seagate_exp/radiology/data/raw/lidc_idri'
    SAVE_PATH = '/mnt/seagate_exp/radiology/data/processed/lidc_idri'

    torch.set_grad_enabled(False)  # No need for gradient calculation in this script

    #data_manager = IDCFileSystemDataManager(DATA_PATH, LIDC_IDRI_INFO).sync_data()
    data_manager = IDCFileSystemDataManager(DATA_PATH, LIDC_IDRI_INFO)
